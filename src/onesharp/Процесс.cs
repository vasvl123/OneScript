...
namespace onesharp
{
    ...
    public class Процесс : IDisposable
    {
        ...
        private readonly object _outputEncoding;

        private Процесс(System.Diagnostics.Process p, object encoding)
        {
            _p = p;
        ...
        public static Процесс Create(string cmdLine, string currentDir = null, bool redirectOutput = false, bool redirectInput = false, IValue encoding = null, MapImpl env = null)
        {
