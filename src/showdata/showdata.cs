...
namespace showdata
{
    class showdata : functions
    {
        ...
        object ИмяЗначение(string Имя = "", string Значение = "")
        {
        ...
        object ВыполнитьДействия(dynamic структЗадача)
        {
            ...
            else if (Действие == Команда["ВставитьАтрибут"])
            {
                if (!(Буфер == Неопределено))
                {
                    var НовыйУзел = БуферДанные.КопироватьВетку(БуферУзел, Данные, Узел, Узел, Истина, Неопределено, Ложь);
            ...
            else if (Действие == Команда["ВставитьДочерний"])
            {
                if (!(Буфер == Неопределено))
                {
                    var НовыйУзел = БуферДанные.КопироватьВетку(БуферУзел, Данные, Узел, Узел, Неопределено, Неопределено, Ложь);
            ...
            else if (Действие == Команда["ВставитьСоседний"])
            {
                if (!(Буфер == Неопределено))
                {
                    var НовыйУзел = БуферДанные.КопироватьВетку(БуферУзел, Данные, Узел, Узел.Родитель, Неопределено, Неопределено, Ложь);
