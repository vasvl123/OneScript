...
namespace showdata
{
    class showdata : functions
    {
        ...
        string ПоказатьМенюИнструменты(ТипВкладка Вкладка, ТипУзел Узел, bool ЭтоАтрибут = false)
        {
        ...
        string ПоказатьСтруктуруУзла(ТипВкладка Вкладка, ТипУзел Узел, bool ЭтоАтрибут = false, string Атрибуты = "", string Дочерний = "")
        {
        ...
        string ОтобразитьПараметры(ТипВкладка Вкладка, ТипУзел Узел)
        {
        ...
        string ОтобразитьDOM(ТипВкладка Вкладка, ТипУзел Узел, ТипУзел Родитель = null, bool Обновить = false, string ТипУзла = "", bool НачальныйУзел = false)
        {
        ...
        string Диалог(ТипВкладка Вкладка, ТипУзел Узел)
        {
        ...
        object УзелСвойствоЗначение(ТипУзел Узел, string СвойствоИмя, object СвойствоЗначение)
        {
            if (!(Узел == Неопределено))
            {
        ...
        object УзелСостояние(ТипВкладка Вкладка, ТипУзел Узел, string СостояниеИмя)
        {
        ...
        object УзелСостояниеЗначение(ТипВкладка Вкладка, ТипУзел Узел, string СостояниеИмя, object СостояниеЗначение, bool Событие = false)
        {
            var УзелСостояние = Вкладка.Состояния.Получить(Узел.Код) as Структура;
            if (УзелСостояние == Неопределено)
            {
        ...
        bool ОбновитьСостояние(ТипВкладка Вкладка, ТипУзел Узел, string Состояние, object Значение, bool Событие = false, bool НачальныйУзел = false)
        {
            ...
            {
                var Родитель = УзелСостояние(Вкладка, Узел, "Родитель") as ТипУзел;
