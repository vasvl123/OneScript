    ...
    class showdata : functions
    {
        ...
        object СформироватьОтвет()
        {
            ...
            if (ОбновитьВкладки == Истина)
            {
                ...
                var Режим = УзелСвойство((Структура)Вкладки.Получить(ТекущаяВкладка), "Режим") as string;
                if (Режим == "design")
                {
        ...
        void УстановитьПараметры(dynamic знПараметры)
        {
            ...
            Локальный = (Параметры.Локальный == "Истина"); // если не локальный то простаивающий процесс будет завершен
                ...
                while (к > 0 && !(ТекущаяУниверсальнаяДатаВМиллисекундах() - НачалоЦикла > 50))
                {
                    ...
                    if (РезультатОбновить == "")
                    {
                        ...
                        if (рСформироватьОтвет)
                        {
                            ...
                            {
                                var Данные = _Данные.Значение as pagedata;
