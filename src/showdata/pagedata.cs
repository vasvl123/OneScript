...
namespace showdata
{
    class pagedata : functions
    {
        ...
        public class тУзел : Структура
        {
            ...
            public тУзел Атрибут { get { return Получить("Атрибут") as тУзел; } set { Вставить("Атрибут", value); } }
            public тУзел Дочерний { get { return Получить("Дочерний") as тУзел; } set { Вставить("Дочерний", value); } }
            public тУзел Соседний { get { return Получить("Соседний") as тУзел; } set { Вставить("Соседний", value); } }
            public тУзел Старший { get { return Получить("Старший") as тУзел; } set { Вставить("Старший", value); } }
            public тУзел Родитель { get { return Получить("Родитель") as тУзел; } set { Вставить("Родитель", value); } }
            public dynamic п { get { return Получить("п") as тУзел; } set { Вставить("п", value); } }
            public dynamic д { get { return Получить("д") as тУзел; } set { Вставить("д", value); } }

            public тУзел(string strProperties, params object[] values)
            {
        ...
        public new тУзел ИмяЗначение(string Имя = "", string Значение = "")
        {
            return new тУзел("Имя, Значение", Имя, Значение) as тУзел;
        }
        ...
        public object УзелСвойство(object Узел, string Свойство)
        {
        ...
        public object ОбновитьПредставление(тУзел _Узел = null)
        {
        ...
        public тУзел ПолучитьУзел(object Код, тУзел Старший = null)
        {
            ...
            foreach (КлючИЗначение _знСтр in мСтр)
            {
                ...
                else
                {
                    if (Узел == Неопределено)
                    {
                        Узел = new тУзел("Код, Имя, Значение, Дочерний, Соседний, Атрибут", Код, "");
                    }
                    if (Ключ == "И")
                    {
                        Ключ = "Имя";
        ...
        тУзел НовыйУзел(тУзел Узел, bool Служебный = false)
        {
            string НовыйКод;
        ...
        public тУзел НовыйАтрибут(тУзел Старший, тУзел СтруктураУзла, bool Служебный = false)
        {
            СтруктураУзла.Вставить("Старший", Старший);
            СтруктураУзла.Вставить("Родитель", Старший);
        ...
        public pagedata(showdata обПроцесс, string Текст = "", string знБазаДанных = "", string знИмяДанных = "", string знПозицияДанных = "") : base("pagedata")
        {
            ...
            Пустой = НовыйУзел(new тУзел("Имя, Родитель", "Пустой", Неопределено), Истина);
