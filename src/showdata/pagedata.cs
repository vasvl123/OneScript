...
namespace showdata
{
    class pagedata : functions
    {
        ...
        object ЗначениеСвойства(Структура _знУзелСвойство, string Имя = null)
        {
        ...
        void ОбъектыОбновитьДобавить(Структура оУзел)
        {
        ...
        object Интерпретировать(dynamic Узел, object _ЭтоАтрибут = null, bool НачальныйУзел = true)
        {
            //Перем Имя, Значение, 
            var Результат = Неопределено;
        ...
        Структура НовоеЗначениеУзла(dynamic Узел, dynamic Значение = null, bool Служебный = false, object _Добавить = null, bool Обновить = true)
        {
        ...
        Структура НайтиАтрибут(dynamic Узел, string ИмяАтрибута, object ЗначениеАтрибута = null)
        {
            Узел = Узел.Атрибут;
            while (!(Узел == Неопределено))
            {
