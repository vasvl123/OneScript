                    ...
                    if (тСобытие == "ПриНажатии")
                    {
                        ...
                        if (!(ЗначениеКнопка is null))
                        {
                                    ...
                                    { // И НЕ вТокен.Значение = "" И НЕ сУзел.Значение = "" Тогда
                                      // добавить связь
                                        ...
                                        { // варианты форм
                                            ...
                                            {
                                                if (!(фУзел1.Соседний == Неопределено))
                                                { // не одна форма
                                                    фУзел1 = null;
                                                }
                                                break;
                            ...
                            else if (ЗначениеКнопка == "conf" || ЗначениеКнопка == "excl" || ЗначениеКнопка == "del" || ЗначениеКнопка == "delgr")
                            {
                                ...
                                var св = сУзел.п.ток1имя + Символы.Таб + сУзел.п.ток1нач + Символы.Таб + сУзел.п.ток1гр + Символы.Таб + сУзел.Имя + Символы.Таб + сУзел.п.ток2имя + Символы.Таб + сУзел.п.ток2нач + Символы.Таб + сУзел.п.ток2гр + Символы.Таб + б;
