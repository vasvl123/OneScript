...
namespace morphserver
{
    class treedb : functions
    {
        ...
        object ДобавитьЗначение(гр, н = 0)
        {
        ...
        object ПолучитьВложенныеЗначения(н)
        {
            буф = Новый БуферДвоичныхДанных(16);
            ОткрытьПотокДанных();
            ПотокДанных.Перейти(н, ПозицияВПотоке.Начало);
